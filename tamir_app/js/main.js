...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Araç Takip Sistemi yüklendi');
...
window.addEventListener('load', function() {
    ...
    if (hero) {
        hero.style.animation = 'fadeInDown 1s ease';
    }
    
    const mainContent = document.querySelector('.main-content');
    if (mainContent) {
        mainContent.style.animation = 'fadeInUp 1s ease 0.3s both';
    }
});
...
// Slideshow animasyonları için CSS ekle
